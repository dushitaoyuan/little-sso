...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = StrUtil.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = StrUtil.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = StrUtil.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = StrUtil.tokenizeToStringArray(path, this.pathSeparator);
