...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = HelperUtil.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = HelperUtil.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = HelperUtil.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = HelperUtil.tokenizeToStringArray(path, this.pathSeparator);
