...
public final class RSAUtil {
    ...
    public static String decryptByPrivateKey(String data, RSAPrivateKey privateKey) throws Exception {
        return Base64.encodeBase64URLSafeString(decryptByPrivateKey(Base64.decodeBase64(data), privateKey));
    }
     ...
     * @return 签名值
     */
    public static byte[] sign(byte[] data, String signAlgorithm, RSAPrivateKey privateKey) {
        try {
            if (null == privateKey) {
                throw new Exception("rsa privateKey is null");
            }
